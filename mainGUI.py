...
#main window widgets
nameLabel = ttk.Label(root, text="Enter your name:", font="mont").grid(row=0, column=0, padx=10, pady=10, sticky=W)
nameEntry = ttk.Entry(root, font="mont", textvariable=nameData).grid(row=0, column=1, padx=10, pady=10)
passLabel = ttk.Label(root, text="Enter your Password:", font="mont").grid(row=1, column=0, sticky=W, padx=10, pady=(0,15))
passEntry = ttk.Entry(root, font="mont", textvariable=uidData, show="*").grid(row=1, column=1, padx=10, pady=(0,15))
submitbtn = ttk.Button(root, text="Submit",command=submitOnClick, style="my.TButton").grid(row=2, column=0, pady=(0,15), columnspan=2)
